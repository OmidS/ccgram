...
from ccbot.handlers.directory_browser import _window_label, build_window_picker
from ccbot.session import (
    SessionManager,
    WindowState,
    parse_emdash_provider,
)
from ccbot.window_resolver import EMDASH_SESSION_PREFIX, is_foreign_window
...
class TestResolveStaleIdsEmdash:
    async def test_preserves_foreign_bindings(
        ...
        monkeypatch.setattr(
            "ccbot.session.config.session_map_file",
